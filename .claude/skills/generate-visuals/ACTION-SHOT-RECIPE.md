...
## SFW
Curate SFW states only; default to pricing/plan-card/clean panels. The vision critic (below) hard-fails
anything risqué, garbled, or off-brand — a wasted render is cheap, a bad published visual is not.
