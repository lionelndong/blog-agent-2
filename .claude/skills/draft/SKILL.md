...
6. **Insert typed visual placeholders.** For every H2 with a `Visual:` block in the annotated outline, emit one placeholder of the matching type per `templates/visual-types.md`. The `generate-visuals` skill realizes these into real assets later.
