# Publish package — Best AI Sexting Apps in 2026: 4 We Actually Recommend
...
2. Title: Best AI Sexting Apps in 2026: 4 We Actually Recommend
3. Slug: ai-sexting-app
4. Description (≤80 chars): Most "best AI sexting app" listicles name fourteen apps and recommend none of
...
```bash
doppler run -- python .claude/skills/format-for-publish/scripts/format_for_strapi.py ai-sexting-app --publish
```
