# Publish package — AI Chatbot No Filter: Adult AI Chat Apps Compared (2026)
...
2. Title: AI Chatbot No Filter: Adult AI Chat Apps Compared (2026)
3. Slug: ai-chatbot-no-filter-2026
4. Description (≤80 chars): Compare adult AI chat apps by what you can verify, not by which one shouts "no
...
```bash
doppler run -- python .claude/skills/format-for-publish/scripts/format_for_strapi.py ai-chatbot-no-filter-2026 --publish
```
