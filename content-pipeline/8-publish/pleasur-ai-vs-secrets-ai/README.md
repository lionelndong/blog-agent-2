# Publish package — Pleasur.ai vs Secrets AI
...
2. Title: Pleasur.ai vs Secrets AI
3. Slug: pleasur-ai-vs-secrets-ai
4. Description (≤80 chars): Every page that ranks for this matchup is either a single-product affiliate
...
```bash
doppler run -- python .claude/skills/format-for-publish/scripts/format_for_strapi.py pleasur-ai-vs-secrets-ai --publish
```
