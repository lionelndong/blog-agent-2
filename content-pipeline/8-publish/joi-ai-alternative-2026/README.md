# Publish package — 7 Best Joi AI Alternatives in 2026
...
2. Title: 7 Best Joi AI Alternatives in 2026
3. Slug: joi-ai-alternative-2026
4. Description (≤80 chars): You're mid-scene, building momentum, and the input box just stops you.
...
```bash
doppler run -- python .claude/skills/format-for-publish/scripts/format_for_strapi.py joi-ai-alternative-2026 --publish
```
...
- Read time: ~21 min (computed at 220 wpm; informational only — not in payload)
- Blocks: 1
