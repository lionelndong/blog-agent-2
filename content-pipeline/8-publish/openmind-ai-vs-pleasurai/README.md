# Publish package — OpenMind AI vs Pleasur.ai: Which One Actually Remembers You?
...
2. Title: OpenMind AI vs Pleasur.ai: Which One Actually Remembers You?
3. Slug: openmind-ai-vs-pleasurai
4. Description (≤80 chars): In MariaVibe's independent 2026 review, Pleasur.ai scored 82% 7-day memory
...
```bash
doppler run -- python .claude/skills/format-for-publish/scripts/format_for_strapi.py openmind-ai-vs-pleasurai --publish
```
