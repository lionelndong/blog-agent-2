# Publish package — Is Candy AI Safe to Use in 2026? What Users Need to Know
...
2. Title: Is Candy AI Safe to Use in 2026? What Users Need to Know
3. Slug: is-candy-ai-safe
4. Description (≤80 chars): Candy AI is a legitimate, widely used AI companion platform, not a scam, and it
...
```bash
doppler run -- python .claude/skills/format-for-publish/scripts/format_for_strapi.py is-candy-ai-safe --publish
```
