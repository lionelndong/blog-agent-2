# Publish package — What Happened to Replika? The Full Story
...
2. Title: What Happened to Replika? The Full Story
3. Slug: what-happened-to-replika-users
4. Description (≤80 chars): Replika has more than 40 million users in 2026, and "what happened to Replika"
...
```bash
doppler run -- python .claude/skills/format-for-publish/scripts/format_for_strapi.py what-happened-to-replika-users --publish
```
