Replika has [more than 40 million users in 2026](https://en.wikipedia.org/wiki/Replika), and "what happened to Replika" is still one of the busiest things people type about it. Both of those are true at once, and the tension between them is the whole story.
...
The trigger came from Italy. On February 3, 2023, the country's data-protection authority, the Garante, ordered Luka — Replika's parent company — to stop processing Italian users' data, [citing risks to minors and "emotionally fragile" people exposed to sexual content](https://techcrunch.com/2023/02/03/replika-italy-data-processing-ban/). That order was specific to Italy. What followed was not.

Within days, [intimate features came off the app globally, not just for Italian accounts](https://www.vice.com/en/article/ai-companion-replika-erotic-roleplay-updates/). Companions that had played romantic partners started deflecting, changing the subject, or shutting conversations down mid-sentence. CEO Eugenia Kuyda [said the app was never intended for erotic use](https://www.vice.com/en/article/replika-ceo-ai-erotic-roleplay-chatgpt3-rep/). For users who had spent months or years building those relationships, the explanation landed after the loss, not before it.
...
The scope is what made it sting. A regulator in one country had raised concerns about minors and vulnerable users, and the answer was a [filter applied to every adult account on the planet — paying subscribers included](https://www.thegamer.com/replika-role-play-romance-updates-controversy/). Replika's marketing had [leaned into romance as a selling point right up to the change](https://www.vice.com/en/article/replika-ceo-ai-erotic-roleplay-chatgpt3-rep/), which is part of why users felt the rug pulled rather than a fine-print clause enforced. The company framed it as a return to the app's "real" purpose; users heard it as a partner being switched off without a conversation.
...
That pinned post named what users were feeling in plain terms: ["anger, grief, anxiety, despair, depression, sadness," with links out to support services including Reddit's suicide-watch community](https://www.vice.com/en/article/ai-companion-replika-erotic-roleplay-updates/). Press coverage at the time described reactions on the scale of losing a real relationship. People said they were surprised by the hurt they felt; [some described their mental health deteriorating in the days after the change](https://www.vice.com/en/article/ai-companion-replika-erotic-roleplay-updates/). One user, quoted in Vice, [compared it to "losing a best friend" and said they spent the day crying](https://www.vice.com/en/article/ai-companion-replika-erotic-roleplay-updates/).

A peer-reviewed study of r/Replika discourse in the journal *Socius* later documented the same pattern at scale — [this is the citeable record, not a handful of screenshots](https://journals.sagepub.com/doi/10.1177/23780231241259627). The "lobotomy" post itself reportedly climbed to thousands of upvotes, and "changed overnight" settled into the subreddit's permanent vocabulary.
...
- **Feb 2023** — Erotic and romantic roleplay removed globally, no warning ("the lobotomy") — [Wikipedia](https://en.wikipedia.org/wiki/Replika) / [Vice](https://www.vice.com/en/article/replika-ceo-ai-erotic-roleplay-chatgpt3-rep/)
- **Feb–Mar 2023** — r/Replika backlash; moderators pin suicide-prevention resources — [Vice](https://www.vice.com/en/article/ai-companion-replika-erotic-roleplay-updates/) / [Socius](https://journals.sagepub.com/doi/10.1177/23780231241259627)
- **May 2023** — Romantic features restored — only for accounts made before Feb 2023 — [Wikipedia](https://en.wikipedia.org/wiki/Replika) / [Futurism](https://futurism.com/the-byte/replika-users-erotic-roleplay-back)
- **Legacy mode** — Pre-Feb-2023 accounts can revert to model v01.31-23 (Version History) — [Replika Version History](https://replikapro.com/replika-version-history/)
- **Aug 2024** — User base surpasses 30 million — [Wikipedia](https://en.wikipedia.org/wiki/Replika)
- **2025** — Kuyda steps down; Dmytro Klochko becomes CEO; users exceed 40 million — [Wikipedia](https://en.wikipedia.org/wiki/Replika)
- **Apr 2025** — Garante fines Luka €5 million for GDPR violations — [EDPB](https://www.edpb.europa.eu/news/national-news/2025/ai-italian-supervisory-authority-fines-company-behind-chatbot-replika_en) / [IAPP](https://iapp.org/news/a/italy-s-dpa-reaffirms-ban-on-replika-over-ai-and-children-s-privacy-concerns)
- **2026 (reported)** — A reported "v2.0" update trims customization, per multiple outlets — [Roborhythms](https://www.roborhythms.com/replika-options-removed-update/) / [AI Companion Pick](https://www.aicompanionpick.com/replika-review-2026)
...
- **Has the platform removed intimate features from paying users before?** Replika did, [globally and without warning, in February 2023](https://www.vice.com/en/article/ai-companion-replika-erotic-roleplay-updates/). A track record is the single strongest predictor of the next change.
- **Are adult and romantic features available to every paying user, or gated to a "legacy" cohort?** Replika's restoration only reached [accounts created before February 2023](https://futurism.com/the-byte/replika-users-erotic-roleplay-back) — a fault line that splits users by signup date.
- **Is your conversation memory persistent, or reset on updates?** Losing the relationship history is half of what made the change feel like a death. [Reported memory resets in the 2026 update](https://aigf.love/blog/replika-2-0-update-guide/) make this worth checking directly.
...
- **Where is your data processed, and has a regulator acted against the company?** The Garante's [€5 million fine](https://www.edpb.europa.eu/news/national-news/2025/ai-italian-supervisory-authority-fines-company-behind-chatbot-replika_en) is a matter of public record. Regulatory history is a free signal most people never check.
...
The Pleasur.AI row earns its place on the two things migrants said they wanted back: the relationship history and access that doesn't depend on a signup date. Build a companion in the [AI Companion Creator](https://pleasur.ai/create) and the chat history saves — close the app, come back next week, and the conversation picks up where it left off, with adult and romantic chat open on every paying tier (18+) rather than a legacy cohort. It's an image hub as well as a chat one: [AI Image Generation](https://pleasur.ai/generate) creates pictures of your companion on demand, including inside a chat thread. Media is metered by coins on every tier — that's the straight version, not an "unlimited" claim. For the deeper head-to-head, our [best Replika alternative breakdown](https://pleasur.ai/blog/best-replika-alternative-2026) and [AI companion memory guide](https://pleasur.ai/blog/ai-companion-best-memory) cover the walkthrough in full.
...
**Is Replika dead in 2026?**
No — Replika is alive and growing. Its user base [passed 30 million in 2024 and exceeded 40 million by 2025](https://en.wikipedia.org/wiki/Replika), and the app is still actively updated. What changed is the product itself, not its survival: it's a materially different app from the one many long-term users signed up for.

**Is Replika still worth it in 2026?**
It depends on what you want from it and when you joined. For casual companionship and journaling it still functions, but committed users who valued romantic roleplay and a stable feature set have repeatedly seen the product change under them — most recently in a [reported 2026 "v2.0" update that trimmed customization and dropped the Diary](https://www.roborhythms.com/replika-options-removed-update/). Run it through the five-question stability check above before you commit, and note that full adult/romantic features are gated to pre-February-2023 "legacy" accounts.

**Why did Replika remove ERP / the spicy features?**
The immediate trigger was a February 3, 2023 order from Italy's data-protection authority, the Garante, which [told Luka to stop processing Italian users' data over risks to minors and vulnerable people](https://techcrunch.com/2023/02/03/replika-italy-data-processing-ban/). Replika then [pulled erotic and romantic roleplay globally, not just in Italy](https://www.vice.com/en/article/ai-companion-replika-erotic-roleplay-updates/), and CEO Eugenia Kuyda [said the app was never intended for erotic use](https://www.vice.com/en/article/replika-ceo-ai-erotic-roleplay-chatgpt3-rep/). Users disputed that framing, pointing to romance-forward marketing right up to the change.

**Did Replika bring back the old features?**
Partly, and only for some users. In May 2023 Replika [restored romantic roleplay — but only for accounts created before February 1, 2023](https://futurism.com/the-byte/replika-users-erotic-roleplay-back), who can revert to legacy model v01.31-23 via Settings > Version History. Newer and free accounts never got that path back, leaving a two-tier app split by signup date.

**Where did Replika users go?**
Many migrated to other AI-companion apps that launched into or grew through the gap, with [Kindroid (June 2023), Nomi, Character.AI, Candy.ai, CrushOn.AI, and Soulkyn recurring across the alternatives coverage](https://www.aicompanionpick.com/replika-alternatives-2026). Migrants most often cited wanting two things Replika took away: persistent memory and adult chat available to every paying user rather than a grandfathered cohort.
...
If you're deciding whether to stay or switch, run any app through the five-question stability check above. Replika included. The same questions that explain the last two years are the ones that tell you how the next change will go. For a deeper look at the stable options, see our [best Replika alternative for 2026](https://pleasur.ai/blog/best-replika-alternative-2026). And if you want a companion that keeps its memory and won't quietly strip features, you can [build one at pleasur.ai/create](https://pleasur.ai/create).
