...
![CNBC: Dutch court threatens €100,000-a-day fine on Grok for AI-generated non-consensual nude images](images/ai-porn/external-1-cnbc-dutch-court-threatens-100.png)
...
![Split diagram labeled "The AI Porn Consent Split". Left panel with green border labeled "CONSENSUAL (Legal)" lists four formats: "Generated Images", "Character Chat & Roleplay", "Generated Video", "Synthetic Voice". Right panel with red border labeled "NON-CONSENSUAL (Harm Vector)" lists: "Real-person deepfakes", "Stolen-face imagery", "Non-consensual intimate images". A bold vertical dividing line with the caption "The Only Split That Matters" runs between the two panels. Clean editorial illustration, white background, sans-serif labels, brand-neutral colors.](images/ai-porn/image-2-split-diagram-labeled-the-ai-p.png)
...
![Three-layer architecture diagram titled "How AI Porn Platforms Are Built". Bottom layer (wide bar) labeled "Diffusion Model (Stable Diffusion / open-source weights)" — a noise-to-image arrow runs through it. Middle layer labeled "LoRA Adapter — character look, style, and consistency". Top layer labeled "Chat + Voice Layer (LLM + TTS)" with a speech bubble and speaker icon. An output arrow on the right points to three outputs: "Generated Image", "Chat Response", "Voice Reply". Upward arrows connect each layer. Clean editorial illustration, white background, sans-serif labels.](images/ai-porn/image-3-three-layer-architecture-diagr.png)
...
![CCDH research report: Grok generated 23,000 sexualized images of children in 11 days — the baseline case for absent training-data accountability](images/ai-porn/external-4-ccdh-research-report-grok-gene.png)
...
![Pleasur.AI terms of service — prohibited content and real-person likeness refusal section visible before signup](images/ai-porn/screenshot-5-pleasur-ai-terms-of-service-pr.png)
...
![Pleasur.AI Companion Creator — templates grid showing character base options on first load](images/ai-porn/screenshot-1-pleasur-ai-companion-creator-t.png)
...
[VISUAL:type=action-shot;url=https://pleasur.ai;goal=Log into Pleasur.AI with the saved session. Open an existing character chat. Type the message "Send me a selfie" and send it. Wait for the AI to generate and return an image inline in the chat thread. Capture the full chat window showing the generated character image appearing as a message within the conversation.;what=In-chat image generation — character-consistent selfie returned inline inside the conversation]
...
![CNBC: City of Baltimore sues xAI and Grok over non-consensual deepfakes — live class action test of platform liability](images/ai-porn/external-4-cnbc-city-of-baltimore-sues-xa.png)
...
![Two-zone diagram titled "AI Content: Legal Safe Harbor vs. Legal Risk (US 2026)". Left zone with green background and checkmark icon, labeled "Safe Harbor": bullet list — "Fictional adult character you design", "Generated by you for personal use", "Platform publishes training-data source", "Platform refuses real-person likeness". Right zone with red background and warning icon, labeled "Legal Risk": bullet list — "Real person without consent", "Platform allows celebrity or named-person prompts", "CSAM — federal crime, any synthetic form", "No visible refusal list before signup". Bold dividing line between zones. Clean editorial illustration, white background, sans-serif labels.](images/ai-porn/image-9-two-zone-diagram-titled-ai-con.png)
...
![Side-by-side comparison titled "AI Companion Platform Stack: 2026 vs Near Future". Left column labeled "Available Now (2026)": three stacked boxes — "Text-to-Image (Diffusion)", "LoRA Character Consistency", "Text Chat + Memory". Right column labeled "Arriving Next": same three boxes plus two additional boxes with dashed borders below — "Voice TTS Replies + Real-Time Calls", "Image-to-Video Short Clips (3–5 sec)". Arrows on the right column show the additive layers building upward. Clean editorial illustration, white background, sans-serif labels.](images/ai-porn/image-11-side-by-side-comparison-titled.png)
